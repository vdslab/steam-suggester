...
export const HomeHeader = () => {
  return (
    <header className="absolute top-0 -left-16 w-full h-[8vh] bg-gradient-to-b from-gray-800 to-transparent text-white flex items-center justify-center z-10 select-none">
